"""
Django settings for FFS_Server project.
...
SECRET_KEY = 'django-insecure-a_$n8dhsz14w#^v^0_1(muv06(sx#ykyjt!crx_bni=ljcrnbe'
...
WSGI_APPLICATION = 'FFS_Server.wsgi.application'
...
AWS_S3_ENDPOINT_URL = 'http://192.168.99.1:9000'
